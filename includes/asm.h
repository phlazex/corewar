...
int				ft_project_init(
		t_project *project, int (*ft_parse)(t_mem *, t_project *));
void			ft_usage();
...
int				ft_is_valid_label(
		t_project *project, char *label, size_t arg_num);
int				ft_is_arg_func(
		t_project *project, size_t arg_num,
		size_t command_size, size_t arg_code);
int				ft_is_ind_dir_func(
		t_project *project, size_t arg_num, size_t i);
